...
const std::unordered_map<uint16_t, std::string> TTFont::unicode_to_adobe =
{ { 0x2022, "/.notdef"},
  { 0x0002, "/controlSOT"},
  { 0x0003, "/controlETX"},
  { 0x0004, "/controlEOT"},
  ...
  { 0x2267, "/notgreaterdblequal"},
  { 0x2271, "/notgreaterequal"},
  { 0x2A7E, "/notgreaterorslnteql"},
  { 0x2266, "/notlessdblequal"},
  { 0x2270, "/notlessequal"},
  { 0x2A7D, "/notlessorslnteql"},
  { 0x2AAF, "/notprecedesoreql"},
  { 0x22AD, "/notsatisfies"},
  { 0x2241, "/notsimilar"},
  { 0x2288, "/notsubseteql"},
