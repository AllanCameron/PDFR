...
const std::unordered_map<Unicode, float> GlyphWidths::courier_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::helvetica_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::helvetica_bold_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::symbol_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::times_bold_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::times_bold_italic_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::times_italic_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::times_roman_widths_ =
{
...
const std::unordered_map<Unicode, float> GlyphWidths::dingbats_widths_ =
{
